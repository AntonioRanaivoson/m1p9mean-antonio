...
@Component({
  selector: 'app-e-kaly-admin-livreur',
  templateUrl: './e-kaly-admin-livreur.component.html',
  styleUrls: ['./e-kaly-admin-livreur.component.css']
})
export class EKalyAdminLivreurComponent implements OnInit {
