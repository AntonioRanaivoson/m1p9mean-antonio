...
@Component({
  selector: 'app-e-kaly-restaurant',
  templateUrl: './e-kaly-restaurant.component.html',
  styleUrls: ['./e-kaly-restaurant.component.css']
})
export class EKalyRestaurantComponent implements OnInit {
  rest_message='';
  restos: Array<IResto> = [];
  isAdmin="";
  email="";
